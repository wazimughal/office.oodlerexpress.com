                                      ...
                                      foreach($products as $key=>$data){
                                        ...
                                        foreach($data['products'] as $k=>$proData){ 
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-1">
                                                    <div class="input-group mb-3">
                                                        <select name="product_details[{{$proData['id']}}][product_sizes][]"  class="form-control">@php echo get_product_sizes($proData['sizes'],$selected_product['size_slug']); @endphp</select>
                                                ...
                                                <div class="col-1"><div style="width: 90px; float:right;" onclick="addmore_items({{$proData['id']}},'{{$proData['slug']}}')"
