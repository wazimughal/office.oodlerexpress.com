                        ...
                        <div class="card card-success">
                            ...
                            <div class="card-body">
                              <div class="row">
                                ...
                                <form method="POST" action="{{ route('drivers.edit',$driverData['id']) }}">
                                    @csrf
                                        ...
                                        <div class="col-6">
                                          <div class="input-group mb-3">
                                            <input type="text" name="firstname" class="form-control @error('firstname') is-invalid @enderror"
                                                placeholder="First name" value="{{ $driverData['firstname']}}">
                                        ...
                                        <div class="col-6">
                                          <div class="input-group mb-3">
                                            <input type="text" name="lastname" class="form-control @error('lastname') is-invalid @enderror"
                                                placeholder="Last name" value="{{ $driverData['lastname']}}">
                                            <div class="input-group-append">
                                                <div class="input-group-text">
                                                    <span class="fas fa-user"></span>
                                                </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-6">
                                        <div class="input-group mb-3">
                                          <input readonly disabled type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                                              placeholder="Email" value="{{ $driverData['email']}}">
                                          <div class="input-group-append">
                                              <div class="input-group-text">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-3">&nbsp;</div>
                                        <div class="col-6">
                                            Leave Password empty if you don't want to change
                                        <div class="input-group mb-3">
                                          <input type="password" name="password" class="form-control @error('password') is-invalid @enderror"
                                              placeholder="Password: Leave empty if you don't want to chagne" value="">
                                          <div class="input-group-append">
                                              <div class="input-group-text">
                                                  <span class="fas fa-envelope"></span>
                                              </div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col-3">&nbsp;</div>
                                        <div class="col-6">
                                            <strong>({{ $driverData['license_no']}})</strong> Leave empty if you don't want to chagne
                                        <div class="input-group mb-3">
                                            
                                          <input type="text" name="license_no" class="form-control @error('license_no') is-invalid @enderror"
                                              placeholder="License No. Leave it empty if you don't want to change" value="">
                                          <div class="input-group-append">
                                              <div class="input-group-text">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="input-group mb-3">
                                          <input type="text" name="address" class="form-control @error('address') is-invalid @enderror"
                                              placeholder="Home Address" value="{{ $driverData['address']}}">
                                          <div class="input-group-append">
                                              <div class="input-group-text">
