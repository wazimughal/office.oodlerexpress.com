...
<body class="hold-transition sidebar-mini layout-fixed" style="position: relative;">
    <div id="_loader"
        style="position: absolute; width:100%;text-align:center;min-height:100%;background-color:rgba(0, 0, 0, 0.3); z-index:9999; display:none">
    ...
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ url('adminpanel/dist/img/AdminLTELogo.png') }}" alt="AdminLTELogo"
                height="60" width="60">
        </div>
