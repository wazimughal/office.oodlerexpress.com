                                ...
                                <table id="example1" class="table table-bordered table-striped table-responsive">
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            ?>
                                        <tr id="row_{{ $data['id'] }}">
                                            <td><strong id="business_name_{{ $data['id'] }}">{{ $data['business_name'] }}</strong></td>
                                            <td><strong id="name_{{ $data['id'] }}">{{ $data['name'] }}</strong></td>
                                            <td id="email_{{ $data['id'] }}">{{ $data['email'] }}</td>
                                            <td id="phone_{{ $data['id'] }}">{{ $data['phone'] }}</td>
                                            <td id="city_state_zip_{{ $data['id'] }}">
                                                    {{ $data['city'] }}<br>
                                                    {{ $data['state'] }}<br>
                                                    {{ $data['zipcode'] }}<br>
                                                    {{ ($data['business_unit_ste']!='')?'Unit/STE:'.$data['business_unit_ste']:'' }}<br>
                                                </td>
                                            <td id="address_{{ $data['id'] }}">
                                                ...
                                                <a href="{{route('subs.open_edit_form',$data['id'])}}"
                                                    class="btn btn-info btn-block btn-sm"><i class="fas fa-edit"></i>
                                                    Edit</a>
                                                    <button
                                                        onClick="do_action({{ $data['id'] }},{{ $counter }},'delete_sub')"
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            <td colspan="7">
                                                <div class="text-right"> {{ $subsData->links() }}</div>
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
    ...
    <div class="modal fade" id="modal-xl-lead">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="card card-success">
                    <div class="card-header">
                        <h3 class="card-title"> subs Panel</h3>
